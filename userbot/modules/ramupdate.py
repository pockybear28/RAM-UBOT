    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari SULTAN-UBOT.`'
            )
            repo.__del__()
            return
        ...
        if heroku_app is None:
            await event.edit(
                f'{txt}\n`Kredensial Heroku tidak valid untuk deploy SULTAN-UBOT dyno.`'
            )
            return repo.__del__()
        ...
        if BOTLOG:
            await event.client.send_message(
                BOTLOG_CHATID, "#BOT \n"
                "`SULTAN-UBOT Berhasil Di Update`")
...
async def update(event, repo, ups_rem, ac_br):
    ...
    if BOTLOG:
        await event.client.send_message(
            BOTLOG_CHATID, "#BOT \n"
            "**SULTAN-UBOT Telah Di Perbarui ツ**")
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru SULTAN-UBOT."
    "\n\n.update one"
    "\nUsage: Memperbarui SULTAN-UBOT."
    "\n\n.update all"
    "\nUsage: Memperbarui SULTAN-UBOT Dengan Cara Deploy Ulang."
})
